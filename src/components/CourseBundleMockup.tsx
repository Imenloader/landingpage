...
export default function CourseBundleMockup() {
  return (
    <section className="w-full py-12 px-4 bg-[#0F172A] overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col items-center">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="w-full max-w-4xl py-12 bg-slate-800 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(79,70,229,0.3)] relative flex items-center justify-center overflow-hidden border-none"
        >
