  ...
  return (
    <footer className="w-full pt-20 pb-10 px-4 bg-[#0F172A] text-gray-400 border-t border-white/10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-12 mb-8">
        ...
        <div className="text-center md:text-right max-w-sm">
          ...
          <div className="flex justify-center md:justify-start gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-[#FCFBF8]/5 flex items-center justify-center hover:bg-indigo-500 hover:text-white transition-all"><Globe size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-[#FCFBF8]/5 flex items-center justify-center hover:bg-pink-500 hover:text-white transition-all"><LinkIcon size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-[#FCFBF8]/5 flex items-center justify-center hover:bg-indigo-700 hover:text-white transition-all"><Mail size={18} /></a>
          </div>
        </div>
        ...
        <div className="flex gap-16 text-center md:text-right">
          <div className="flex flex-col gap-3">
            ...
            <a href="#" className="text-sm hover:text-white transition-colors flex items-center justify-center md:justify-start gap-2">الباقة الشاملة <span className="bg-indigo-500 text-white text-[10px] px-2 py-0.5 rounded-full font-bold">عرض</span></a>
          </div>
      ...
      <div className="max-w-7xl mx-auto border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p className="text-xs flex items-center gap-1">مبني بـ <span className="text-amber-500">♥</span> لصناع المحتوى.</p>
      </div>
    </footer>
  );
}
