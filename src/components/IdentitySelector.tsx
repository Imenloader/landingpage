  ...
  return (
    <section className="w-full py-24 px-4 bg-[#FCFBF8]">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-extrabold text-[#0F172A] mb-4">إنت مين في دول؟</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-[#0F172A]">أنا فريلانسر / مقدم خدمات</h3>
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-[#0F172A]">أنا صانع محتوى / خبير</h3>
        ...
        <AnimatePresence>
          {selected && (
            <motion.div 
              ...
              className="bg-[#1E293B] text-white p-6 rounded-2xl flex items-center gap-4 text-right shadow-xl"
            >
              <CheckCircle2 size={32} className="text-[#10B981] shrink-0" />
              <div>
