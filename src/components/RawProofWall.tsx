    ...
    <section className="w-full py-32 px-4 bg-[#F8FAFC] relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="bg-[#FCFBF8] p-4 rounded-2xl rounded-br-none shadow-sm max-w-[85%] self-end mb-2 relative">
              ...
              <div className="text-right mt-1 text-[10px] text-gray-400">10:42 AM <span className="text-indigo-500 font-bold">✓✓</span></div>
              <div className="absolute -right-2 bottom-0 w-4 h-4 bg-[#FCFBF8] clip-polygon-whatsapp"></div>
            </div>
            <div className="absolute top-4 right-4 bg-[#FCFBF8]/80 backdrop-blur text-xs px-3 py-1 rounded-full text-gray-600 font-medium">WhatsApp Chat</div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="bg-[#FCFBF8] p-6 rounded-[2rem] border border-gray-100 shadow-lg flex flex-col items-center justify-center min-h-[250px]"
          >
            <p className="text-center font-bold text-[#0F172A] mb-6">"أول منتج ديجيتال أطلقه جاب 50 مبيعة وأنا نايم..."</p>
            <div className="w-full bg-gray-100 rounded-full h-12 flex items-center px-4 gap-3 cursor-pointer hover:bg-gray-200 transition-colors">
              ...
              <div className="flex-1 flex items-center gap-1">
                {[...Array(15)].map((_, i) => (
                  <div key={i} className="w-1 bg-indigo-400 rounded-full" style={{ height: `${Math.random() * 20 + 4}px` }}></div>
                ))}
              </div>
          ...
          <motion.div 
            ...
            className="bg-[#FCFBF8] p-6 rounded-[2rem] border border-gray-100 shadow-lg flex flex-col justify-center min-h-[250px]"
          >
            <div className="flex items-center gap-4 mb-6 border-b pb-4">
              ...
              <div>
                <p className="font-bold text-[#0F172A]">Stripe Payment</p>
                <p className="text-xs text-gray-500">Just now</p>
              </div>
            </div>
            <div className="text-center">
              <p className="text-gray-500 text-sm mb-1">New payment received</p>
              <p className="text-4xl font-extrabold text-[#0F172A]">$497.00</p>
            </div>
