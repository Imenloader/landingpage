    ...
    <section className="w-full py-20 px-4 bg-[#0F172A] relative z-20 -mt-10">
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="w-full aspect-video bg-[#1E293B] rounded-[2rem] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden relative group cursor-pointer"
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-24 h-24 bg-[#FCFBF8]/10 backdrop-blur-md rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
              <PlayCircle size={48} className="text-white ml-2" />
            </div>
          </div>
          
          {/* Progress bar simulation */}
          <div className="absolute bottom-0 left-0 w-full h-1 bg-[#FCFBF8]/20">
